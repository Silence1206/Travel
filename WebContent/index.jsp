    ...
    <div class="sceneView fn-clear ">
        <div class="scenePic">
			<ul id="slider" class="slider">
            	<li>
					<a href="">
						<img src="${pageContext.request.contextPath }/images/intro_201301102119_-1.jpg" width="530" height="325" alt="观澜版画村 画中有话" title="观澜版画村 画中有话">
					</a>
                ...
                <li>
					<a href="">
						<img src="${pageContext.request.contextPath }/images/intro_201301102121_-1.jpg" width="530" height="325" alt="玩水嬉游 海滩撒欢" title="玩水嬉游 海滩撒欢">
					</a>
                    <div class="alpha-txt txt-info">
                        <h2>玩水嬉游 海滩撒欢</h2>
                ...
                <li>
                    <a href="">
                        <img src="${pageContext.request.contextPath }/images/intro_201301102121_-2.jpg" width="530" height="325" alt="大鹏古城 深圳发源地" title="大鹏古城 深圳发源地">
                    </a>
                    <div class="alpha-txt txt-info">
                        <h2>大鹏古城 深圳发源地</h2>
                ...
                <li>
                    <a href="">
                        <img src="${pageContext.request.contextPath }/images/intro_201301102121_-3.jpg" width="530" height="325" alt="大望梧桐  深圳桃花源" title="大望梧桐  深圳桃花源">
                    </a>
                    <div class="alpha-txt txt-info">
                        <h2>大望梧桐  深圳桃花源</h2>
                ...
                <li>
                    <a href="">
                        <img src="${pageContext.request.contextPath }/images/intro_201301102121_-4.jpg" width="530" height="325" alt="一街两制  中英街" title="一街两制  中英街">
                    </a>
                    <div class="alpha-txt txt-info">
                        <h2>一街两制  中英街</h2>
        ...
        <div class="sceneIntro">
			...
			<div class="scoreSec"><br /><br /><br /><br /><br />
				<ul class="scene-thumbnail" id="scene-thumbnail">
					<li>
						<a href="${pageContext.request.contextPath }/images/5f45080874b9502e80cbfcc3e10c6dd3-175-175.jpg" target="_blank"
						   rel="gallery" class="thumbnail">
							<img src="${pageContext.request.contextPath }/images/5f45080874b9502e80cbfcc3e10c6dd3-175-175_c.jpg" alt="teamleader" width="70" height="70"></a>
					</li>
					<li>
						<a href="${pageContext.request.contextPath }/images/8ec44886bac029c30e931b67be5922ec-175-175.jpg" target="_blank"
						   rel="gallery" class="thumbnail">
